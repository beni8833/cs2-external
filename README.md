...
## 🚀 Features
### AimBot
- Key activation with Recoil Control System (RCS).
- Visibility check.

### ESP
- Skeleton display (Team color).
- Box with health bar.
- Health numbers.
- Player name.
- Enemy weapon icon. (Install the font from the Releases page).
- Enemy flags for Scoped, Flashed, and Shifting statuses.
- Team Check to filter enemies or teammates in the config file.
...
4. Extract the downloaded file if it is in a zipped format.
5. Run the application by double-clicking the executable file.

## ⚙️ Configuration
After installing, you might want to customize the settings:

1. Open the config file found in the downloaded folder.
2. Adjust the hotkeys and other preferences as per your gaming style.
3. Save the changes before launching the application.

## 📜 Usage Instructions
1. Launch cs2-external.
2. Adjust your settings as specified above.
3. Press the activation key for the features you wish to use.

## ❓ FAQs
### Can I use cs2-external in online matches?
